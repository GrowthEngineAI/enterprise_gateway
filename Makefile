...
.PHONY: help build clean nuke dev dev-http docs install sdist test release clean-images clean-enterprise-gateway \
	...
	clean-elyra \
	clean-kernel-tf262-py clean-kernel-tf270-gpu-py \
	clean-pt110-cuda113-py clean-pt110-ds-apex-py \
	...
	push-kernel-tf262-py push-kernel-tf270-gpu-py \
	push-pt110-cuda113-py push-pt110-ds-apex-py \
...
docker-images: elyra demo-base enterprise-gateway-demo kernel-images enterprise-gateway kernel-py kernel-spark-py kernel-r kernel-spark-r kernel-scala kernel-tf-py kernel-tf-gpu-py kernel-tf262-py kernel-tf270-gpu-py kernel-pt110-cuda113-py kernel-pt110-ds-apex-py kernel-image-puller
#docker-images: enterprise-gateway kernel-image-puller

elyra enterprise-gateway-demo kernel-images enterprise-gateway kernel-py kernel-spark-py kernel-r kernel-spark-r kernel-scala kernel-tf-py kernel-tf-gpu-py kernel-tf262-py kernel-tf270-gpu-py kernel-pt110-cuda113-py kernel-pt110-ds-apex-py kernel-image-puller:
...
clean-images clean-elyra clean-enterprise-gateway-demo clean-kernel-images clean-enterprise-gateway clean-kernel-py clean-kernel-spark-py clean-kernel-r clean-kernel-spark-r clean-kernel-scala clean-kernel-tf-py clean-kernel-tf-gpu-py clean-kernel-tf262-py clean-kernel-tf270-gpu-py clean-kernel-pt110-cuda113-py clean-kernel-pt110-ds-apex-py clean-kernel-image-puller:
...
push-images push-elyra push-enterprise-gateway-demo push-kernel-images push-enterprise-gateway push-kernel-py push-kernel-spark-py push-kernel-r push-kernel-spark-r push-kernel-scala push-kernel-tf-py push-kernel-tf-gpu-py push-kernel-tf262-py push-kernel-tf270-gpu-py push-kernel-pt110-cuda113-py push-kernel-pt110-ds-apex-py push-kernel-image-puller:
	make WHEEL_FILE=$(WHEEL_FILE) VERSION=$(VERSION) TAG=$(TAG) -C etc $@
